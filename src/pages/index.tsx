  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Restaurant Booking Engine, streamline your reservations and menu management - an efficient solution for customers and restaurant employees alike."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Restaurant Booking Engine, streamline your reservations and menu management - an efficient solution for customers and restaurant employees alike.`}
            </Text>
            <Box
